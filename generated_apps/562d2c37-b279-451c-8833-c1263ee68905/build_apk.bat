@echo off
echo CustomApp APK Olusturuluyor...
echo.

cd /d "c:\codecraftai\backend\..\generated_apps\562d2c37-b279-451c-8833-c1263ee68905"
...
echo 3. Bu klasoru sec: c:\codecraftai\backend\..\generated_apps\562d2c37-b279-451c-8833-c1263ee68905
...
start "" "c:\codecraftai\backend\..\generated_apps\562d2c37-b279-451c-8833-c1263ee68905"
