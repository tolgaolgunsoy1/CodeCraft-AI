@echo off
echo HealthTracker APK Olusturuluyor...
echo.

cd /d "c:\codecraftai\backend\..\generated_apps\86afc7b8-d8bf-4328-b6d6-740df6d5040f"
...
echo 3. Bu klasoru sec: c:\codecraftai\backend\..\generated_apps\86afc7b8-d8bf-4328-b6d6-740df6d5040f
...
start "" "c:\codecraftai\backend\..\generated_apps\86afc7b8-d8bf-4328-b6d6-740df6d5040f"
