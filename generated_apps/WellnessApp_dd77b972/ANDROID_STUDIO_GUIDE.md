# WellnessApp - Android Studio Import Rehberi
...
- Bu klasörü seçin: `c:\codecraftai\backend\..\generated_apps\WellnessApp_dd77b972`
...
```bash
cd c:\codecraftai\backend\..\generated_apps\WellnessApp_dd77b972
./gradlew assembleDebug
```
