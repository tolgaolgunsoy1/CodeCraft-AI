# MediCare - Android Studio Import Rehberi
...
- Bu klasörü seçin: `C:\codecraftai\backend\..\generated_apps\MediCare_94384aa7`
...
```bash
cd C:\codecraftai\backend\..\generated_apps\MediCare_94384aa7
./gradlew assembleDebug
```
