# EduPro - Android Studio Import Rehberi
...
- Bu klasörü seçin: `c:\codecraftai\backend\..\generated_apps\EduPro_49bc77d1`
...
```bash
cd c:\codecraftai\backend\..\generated_apps\EduPro_49bc77d1
./gradlew assembleDebug
```
