@echo off
echo EduPro APK Olusturuluyor...
echo.

cd /d "c:\codecraftai\backend\..\generated_apps\EduPro_49bc77d1"
...
echo 3. Bu klasoru sec: c:\codecraftai\backend\..\generated_apps\EduPro_49bc77d1
...
start "" "c:\codecraftai\backend\..\generated_apps\EduPro_49bc77d1"
